    ...
    def handle_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                ...
                if not self.next_turn:
                    if self.capital_blue.collidepoint(event.pos[0], event.pos[1]) and not self.capital_buttons and not self.spawn_factory and not self.spawn_soldier:
                    ...
                    elif self.capital_buttons and self.spawn_soldier_button_clicked.collidepoint(event.pos[0], event.pos[1]):
                        ...
                        self.is_spawn_soldier_button_clicked = False
                    elif self.capital_buttons and self.spawn_factory_button_clicked.collidepoint(event.pos[0], event.pos[1]):
                        self.objects.remove(self.bg_for_buttons)
                        self.objects.remove(self.spawn_soldier_button)
                        self.objects.remove(self.spawn_factory_button)
                        self.objects.remove(self.spawn_factory_button_clicked)
                        ...
                        for i in self.objects:
                            if i.type() == 'soldier' and i.collidepoint(event.pos[0], event.pos[1]) and i.color() == 'blue':
                                self.remover = i
                                self.counter = True
                    ...
                    if self.capital_red.collidepoint(event.pos[0], event.pos[1]):
                        self.capital_buttons = True
                        self.objects.append(self.bg_for_buttons)
                        self.objects.append(self.spawn_soldier_button)
                        self.objects.append(self.spawn_factory_button)
                        ...
                        for i in self.objects:
                            if i.collidepoint(event.pos[0], event.pos[1]) and i.color() == 'red':
                                self.remover = i
                                self.counter = True
                        if self.counter == True:
                        ...
                        if not (event.pos[0]//40 > self.soldier_red_clicked._rect.x//40+1
                                    ...
                                    or event.pos[1]//40 < self.soldier_red_clicked._rect.y//40-1) and not (event.pos[0]//40 != self.soldier_red_clicked._rect.x//40 and event.pos[1]//40 != self.soldier_red_clicked._rect.y//40):
                            for i in self.objects:
                                if i.color() == 'blue' and i.collidepoint(event.pos[0], event.pos[1]):
                                    self.objects.remove(i)
